...
namespace sk::cio {
    ...
    template <typename Char> struct pmr_channel_base {
    ...
    template <typename Char> struct pmr_oseqchannel : pmr_channel_base<Char> {
        virtual auto
    ...
    template <typename Char> struct pmr_iseqchannel : pmr_channel_base<Char> {
        virtual auto
     ...
     */
    template <typename Char> struct basic_pmr_async_writable_adapter_base {
